...
export type Q3PreReqTs = typeof IDL;
// Typed accounts
export type ApplicationAccount = IdlAccounts<Q3PreReqTs>["ApplicationAccount"];

// Typed enums/types defined in IDL
export type Q3PreReqsRsTypes = IdlTypes<Q3PreReqTs>;
